...
var trendEst = trendSummary.map(a => a.trend);
var trendSpp = trendSummary.map(a => a.species);
...
console.log('Show me the money:' + ordTrend_positionInfo.width);

console.log(ordTrend_positionInfo);
...
.attr("opacity", d => d.StatSig ? "1" : "0.5")
